#
#  Be sure to run `pod spec lint HHAlertView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "HHAlertView"
  s.version      = "0.0.2"
  s.summary      = "An iOS AlertView Library ."
  ...
  s.source       = { :git => "https://github.com/mrchenhao/HHAlertView.git", :tag => "0.0.2" }
